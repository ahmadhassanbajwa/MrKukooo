...
export default function CartDrawer({
  ...
  const deliveryFee = orderType === 'Delivery' ? (deliveryDistance <= 5.0 ? 0 : 150) : 0;
  ...
  const handleCheckoutSubmit = async (e) => {
    ...
    if (orderType === 'Delivery') {
      ...
      if (deliveryDistance > 15.0) {
        errors.geofence = `Out of Range. We deliver up to 15km. Current: ${deliveryDistance.toFixed(1)}km`;
      }
    }
  ...
  return (
    <Wrapper className={wrapperClass}>
      <div className={innerClass}>
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <form onSubmit={handleCheckoutSubmit} className="space-y-4 border-t-2 border-dashed border-gray-150 pt-5">
                <h3 className="text-xs font-black text-accent uppercase tracking-wider">Delivery details</h3>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg comic-border-sm text-[10px] font-bold text-accent">
                        ...
                        {deliveryDistance <= 5.0 ? (
                          ...
                          <span className="text-primary">🛵 Rs. 150 Delivery Fee</span>
                        )}
                      </div>
                      {formErrors.geofence && (
        ...
        {/* Footer */}
        {cart.length > 0 && (
          <div className="p-6 border-t-2 border-dashed border-gray-150 bg-gray-50 space-y-4">
            ...
            <button
              ...
              className={`w-full bg-primary text-white font-black py-4 rounded-xl flex items-center justify-center gap-2 cursor-pointer text-sm uppercase tracking-wider ${!isInline && 'comic-border-sm comic-shadow-sm comic-hover'}`}
            >
