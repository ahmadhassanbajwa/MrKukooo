        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100 text-xs font-bold text-accent">
            {filtered.length > 0 ? (
              ...
              <tr>
                <td colSpan="7" className="text-center py-12 text-gray-400 uppercase font-black">
      ...
      {selectedOrder && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl comic-border comic-shadow-xl w-full max-w-lg overflow-hidden flex flex-col max-h-[85vh] animate-scale-up">
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-150 flex items-center justify-between font-bold text-xs">
