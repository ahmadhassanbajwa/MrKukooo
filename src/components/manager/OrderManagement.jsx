                    ...
                    <td className="py-4">
                      ...
                      {getOrderDiscount(o) > 0 && (
                        <span className="block text-[10px] text-red-600 font-bold">
                          -Rs. {getOrderDiscount(o)} {o.voucher_code ? `(${o.voucher_code})` : 'disc'}
                        </span>
                      )}
                    </td>
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-150 font-bold text-xs space-y-2">
              {getOrderDiscount(selectedOrder) > 0 && (
                <div className="flex items-center justify-between text-red-600">
                  <span>Discount Applied {selectedOrder.voucher_code ? `(${selectedOrder.voucher_code})` : ''}:</span>
                  <span className="font-black">- Rs. {getOrderDiscount(selectedOrder)}</span>
                </div>
              )}
