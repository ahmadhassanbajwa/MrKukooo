...
export default function InventoryManager({ 
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-5 rounded-2xl comic-border comic-shadow-sm flex flex-col md:flex-row justify-between gap-4 items-center">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 border border-blue-100">
            <Package className="w-5 h-5" />
          </div>
          <div>
            <h2 className="font-black text-accent text-lg">Dependency Inventory</h2>
            <p className="text-xs text-gray-500 font-bold">Map raw ingredients to menu items</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl comic-border comic-shadow-sm flex flex-col h-[700px]">
        ...
        <div className={`bg-white rounded-2xl comic-border comic-shadow-sm flex flex-col h-[700px] transition-opacity ${!selectedIngredient ? 'opacity-50 pointer-events-none' : ''}`}>
          <div className="p-4 border-b-2 border-gray-100 bg-gray-50/50 rounded-t-2xl">
            <h3 className="font-black text-accent mb-3 flex items-center gap-2">
